Pod::Spec.new do |s|
  s.name             = "InnovidAdRenderer_xcode11.2.1"
  s.version          = '1.5.35-alpha.7'
...
TODO: Add long description of the pod here.
  ...
  s.source = {
    :http => "https://s-video.innovid.com/common/tvos/releases/InnovidAdRenderer.framework-#{s.version}-xcode11.2.1.zip?cachebuster=#{Time.now.to_i}"
  }
