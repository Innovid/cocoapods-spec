Pod::Spec.new do |s|
  s.name             = "InnovidAdRenderer_xcode12.5.1"
  s.version          = '1.6.6'
...
TODO: Add long description of the pod here.
  ...
  s.source = {
    :http => "https://s-video.innovid.com/common/tvos/releases/InnovidAdRenderer.xcframework-#{s.version}-xcode12.5.1.zip?cachebuster=#{Time.now.to_i}"
  }
