Pod::Spec.new do |s|
  s.name             = "InnovidAdRenderer_#{ENV['XCODE_VERSION']}"
  s.version          = '1.3.21'
  s.summary          = 'Innovid Ad Renderer TvOS framework'
  s.module_name      = "InnovidAdRenderer_#{ENV['XCODE_VERSION']}"
  s.swift_version    = '3.2'
...
TODO: Add long description of the pod here.
  ...
  s.source = {
    :http => "https://s-video.innovid.com/common/tvos/releases/InnovidAdRenderer.framework-#{s.version}-#{ENV['XCODE_VERSION']}.zip?cachebuster=#{Time.now.to_i}"
  }
