Pod::Spec.new do |s|
  s.name             = "InnovidAdRenderer_xcode10.1.0"
  s.version          = '1.5.35-alpha.2'
...
TODO: Add long description of the pod here.
  ...
  s.source = {
    :http => "https://s-video.innovid.com/common/tvos/releases/InnovidAdRenderer.framework-#{s.version}-xcode10.1.0.zip?cachebuster=#{Time.now.to_i}"
  }
