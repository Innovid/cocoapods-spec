Pod::Spec.new do |s|
  s.name             = "InnovidAdRenderer_xcode11.3.0"
...
TODO: Add long description of the pod here.
  ...
  s.source = {
    :http => "https://s-video.innovid.com/common/tvos/releases/InnovidAdRenderer.framework-#{s.version}-xcode11.3.0.zip?cachebuster=#{Time.now.to_i}"
  }
